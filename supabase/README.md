...
Si ya tenías `library.sql` antiguo, vuelve a ejecutarlo: añade las tablas `library_likes` y `library_playlists`, y activa Realtime para sync automática sin pulsar «Actualizar».
