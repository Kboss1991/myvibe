...
- **podcasts seguidos** y **progreso de episodios** (`podcast-sync.sql`)
...
Para podcasts: SQL Editor → ejecuta `podcast-sync.sql`. Así se sincronizan los shows que sigues y hasta dónde llegaste en cada episodio.
